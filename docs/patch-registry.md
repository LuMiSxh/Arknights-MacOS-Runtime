...
| ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [`wine-ace-ntoskrnl-surface`](../patches/wine/ace/ntoskrnl/0001-ntoskrnl-compatibility-surface.patch)  | Kernel exports and process metadata required by the ACE client, including callable current-thread process, image-name, audit-parameter, and persistent-thread-state surfaces. | Compatibility-only routes use the ACE gate; `PsGetProcessImageFileName` remains unconditional for valid process objects and returns `NULL` only for a `NULL` input. | Endfield FineWine port; see [provenance](../patches/wine/ace/provenance.md). Compile both architectures and exercise gated and general routes. |
