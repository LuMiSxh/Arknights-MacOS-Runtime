...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ | --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [`wine-ace-ntoskrnl-surface`](../patches/wine/ace/ntoskrnl/0001-ntoskrnl-compatibility-surface.patch)  | Kernel exports and process metadata required by the ACE client.    | ACE gate; existing stub behavior otherwise.                           | Endfield FineWine port; see [provenance](../patches/wine/ace/provenance.md). Compile and exercise both routes. |
